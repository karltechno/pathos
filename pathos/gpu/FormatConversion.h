...
#define GPU_FMT_ALL \
	...
	GPU_FMT_ONE(gpu::Format::R32G32B32A32_Float, DXGI_FORMAT_R32G32B32A32_FLOAT) \
	GPU_FMT_ONE(gpu::Format::R16_Uint, DXGI_FORMAT_R16_UINT) \
	GPU_FMT_ONE(gpu::Format::R32_Uint, DXGI_FORMAT_R32_UINT) \
	GPU_FMT_ONE(gpu::Format::D32_Float, DXGI_FORMAT_D32_FLOAT) \
